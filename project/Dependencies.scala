...
object Dependencies {
  ...
  val versionFusion = "2.0.0-SNAPSHOT"

  val _fusionCommon = "com.helloscala.fusion" %% "fusion-common" % versionFusion
  val _fusionCore = "com.helloscala.fusion" %% "fusion-core" % versionFusion
  val _fusionProtobufV3 = "com.helloscala.fusion" %% "fusion-protobuf-v3" % versionFusion
  val _fusionTestkit = "com.helloscala.fusion" %% "fusion-testkit" % versionFusion
